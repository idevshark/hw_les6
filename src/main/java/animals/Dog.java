...
public class Dog extends Animals implements Climb, Swim {

    private final String animalType = "Собачка";
    private final String voice = "гав-гав";
    private String animalName;
    private String breed;
    private Animals animals;

    public Dog(String animalName, int speed, String food, String breed, boolean climb, boolean swim) {
